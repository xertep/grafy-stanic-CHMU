...
Další funkce umožňují zobrazit různé meteorologické prvky z vybraných regionů v jednom grafu.
...
Additional features allow users to visualize various meteorological elements from selected regions within a single graph.
